...
### Resumen de Recursos
| Componente         | Almacenamiento | CPU | RAM     | IP                | # 🚀 TAS - Technical Assistance System
...
1. Clona el repositorio:
   ```bash
   git clone https://github.com/tu_usuario/proyecto-web-tas.git# 🚀 TAS - Technical Assistance System
...
### Resumen de Recursos
| Componente         | Almacenamiento | CPU | RAM     | IP                 | GATEWAY                 |
|--------------------|----------------|-----|---------|--------------------|-------------------------|
| Máquina Host       | 465GB          | 8   | 8GB     | 100.77.20.132      | 100.77.20.1             |
| Cliente            | 14GB           | 1   | 2GB     | 192.168.1.10/24    | 192.168.1.1             |
| Router             | 14GB           | 1   | 2GB     | 192.168.1.1/24     | 192.168.1.1             |
| NGINX              | 14GB           | 1   | 2GB     | 192.168.100.102/24 | 192.168.1.1             |
